...
void GenRoadset::SetMap(AnaGmc* ana_gmc)
{
  m_map_pos_top = ana_gmc->GetRoadMapPosTop();
  m_map_pos_bot = ana_gmc->GetRoadMapPosBot();
  m_map_neg_top = ana_gmc->GetRoadMapNegTop();
  m_map_neg_bot = ana_gmc->GetRoadMapNegBot();
